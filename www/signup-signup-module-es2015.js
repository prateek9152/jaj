...
let SignupPage = class SignupPage {
    constructor(router, menuCtrl, formBuilder, modalController, toastService, ionLoader, http, authService, storage, alertctrl) {
        this.router = router;
    ...
    ngOnInit() {
        this.registerForm = this.formBuilder.group({
            ...
            primary_mobile_number: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
    ...
    signup() {
        ...
        this.authService.addUser(this.registerForm.value).subscribe((response) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (response) {
