  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
    ...
    function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var SignupPage = /*#__PURE__*/function () {
        function SignupPage(router, menuCtrl, formBuilder, modalController, toastService, ionLoader, http, authService) {
        ...
        _createClass(SignupPage, [{
          ...
          value: function ngOnInit() {
            this.registerForm = this.formBuilder.group({
              ...
              phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(10)])),
          ...
          value: function signup() {
            ...
            this.router.navigate(['/menu/verify']); // var formData = new FormData();
