(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
    ...
    /***/
    function srcApp_helpersUsernameValidatorTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _helpers_username_validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../_helpers/username.validator */
      "./src/app/_helpers/username.validator.ts");
      /* harmony import */
        ...
        _createClass(SignupPage, [{
          ...
          value: function ngOnInit() {
            this.registerForm = this.formBuilder.group({
              ...
              user_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_helpers_username_validator__WEBPACK_IMPORTED_MODULE_6__["UsernameValidator"].validUsername, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(25), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9]+$'), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
          ...
          value: function signup() {
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpHeaders"]({
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        this.router.navigate(['/menu/verify']); //         if(response.status==1){
