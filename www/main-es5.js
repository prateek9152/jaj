(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
      var map = {
        "../home/home.module": ["./src/app/home/home.module.ts", "common", "home-home-module"],
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_modules__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./components.modules */
      ...
      var _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      ...
      /*! ngx-socket-io */
      "./node_modules/ngx-socket-io/__ivy_ngcc__/fesm2015/ngx-socket-io.js"); // import { IonicStorageModule } from '@ionic/storage';
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _components_modules__WEBPACK_IMPORTED_MODULE_10__["ComponentModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_12__["IonicStorageModule"].forRoot(), ngx_socket_io__WEBPACK_IMPORTED_MODULE_14__["SocketIoModule"].forRoot(config)],
        providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], {
          provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"],
          useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"]
        }, _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_11__["Camera"], _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_13__["Contacts"]],
    ...
    /***/
    function srcAppComponentsModulesTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppConfigConfigTs(module, __webpack_exports__, __webpack_require__) {
      ...
      Config.profileLink = "https://ionicinto.wdipl.com/tabs/consultant-profile-view/"; //static ApiUrl = "http://ionicinto.wdipl.com/";
    ...
    function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(http, httpErrorHandler, router, storage, platform, toastController, commonService) {
          var _this4 = this;
        ...
        _createClass(AuthService, [{
          ...
          value: function ifLoggedIn() {
            var dataPromise = this.storage.get('userToken');
    ...
    function srcAppServicesCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CommonService = /*#__PURE__*/function () {
        function CommonService(alertController, toastController, loadingController, storage, settingsService, router, modalController, popoverController, pickerController, navCtrl, http, httpErrorHandler) {
        ...
        _createClass(CommonService, [{
                    ...
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          text: 'Cancel',
                          role: 'cancel',
                          handler: function handler(data) {// console.log('Cancel clicked');
                          }
                        }, {
                          text: 'Login',
                          handler: function handler(data) {
                            if (Url != '' && Url != null) {
                              ...
                              _this5.router.navigate([Url, name]).then(function (e) {
                                if (e) {} else {}
                              });
                            }
                          }
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this6.router.navigate([redirrectUrl, id]).then(function (e) {
                              if (e) {} else {}
                            });
                          }
                        }]
          ...
          value: function loggingout() {
            ...
            this.storage.get('userData').then(function (value) {
              return _this8.settingsService.logout().subscribe(function (data) {
                ...
                _this8.dismissLoader();

                _this8.router.navigateByUrl('/signin');

                _this8.navCtrl.navigateRoot;
              }, function (err) {
                _this8.storage.clear();
          ...
          key: "dismissPopover",
          value: function dismissPopover(dataArray) {
          ...
          key: "presentItemPicker",
          value: function presentItemPicker() {
          ...
          key: "getUsersById",
          value: function getUsersById(formData) {
          ...
          key: "loadVideoType",
          value: function loadVideoType(formData) {
          ...
          key: "likedPost",
          value: function likedPost(formData) {
          ...
          key: "bookmarkPost",
          value: function bookmarkPost(formData) {
    ...
    function srcAppServicesHttpErrorHandlerServiceTs(module, __webpack_exports__, __webpack_require__) {
        ...
        function HttpErrorHandlerService(messageService) {
          ...
          this.createHandleError = function () {
            ...
            return function () {
              ...
              return _this10.handleError(serviceName, operation, result);
            };
          };
        }
      ...
      HttpErrorHandlerService.ctorParameters = function () {
        return [{
          type: _message_service__WEBPACK_IMPORTED_MODULE_3__["MessageService"]
        }];
      };

      HttpErrorHandlerService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function srcAppServicesSettingsServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("x-app-id", "93012253").set("x-app-key", "cff839f34a8901afade9652f4c6bced9");

      var SettingsService = /*#__PURE__*/function () {
        function SettingsService(http, httpErrorHandler, storage) {
        ...
        _createClass(SettingsService, [{
          ...
          key: "contactAdmin",
          value: function contactAdmin(data) {
          ...
          key: "additionalInfo",
          value: function additionalInfo(data) {
            // tslint:disable-next-line: max-line-length
          ...
          key: "addDeviceToken",
          value: function addDeviceToken(data) {
          ...
          key: "getMyProfileData",
          value: function getMyProfileData() {
            // tslint:disable-next-line: max-line-length
          ...
          key: "getBookmarkPost",
          value: function getBookmarkPost() {
            // tslint:disable-next-line: max-line-length
          ...
          key: "commentDisableUpdate",
          value: function commentDisableUpdate(data) {
          ...
          key: "getNotificationControl",
          value: function getNotificationControl() {
          ...
          key: "setNotificationControl",
          value: function setNotificationControl(data) {
          ...
          key: "userIndentityVerify",
          value: function userIndentityVerify(formData) {
          ...
          key: "trilloRecordUpdate",
          value: function trilloRecordUpdate() {
          ...
          key: "getCountryCodeApi",
          value: function getCountryCodeApi() {
